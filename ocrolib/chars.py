...
symbols = ur"""!"#$%&'()*+,-./:;<=>?@[\]^_`{|}~"""
urdu = u"ا آ أ إ ’ٱ ا آ أ إ ا ل ك ʿع غ ح خ ج ف ق ط ظ ʾء ه ة و ؤ ر ز د ذ ي ئ ى م ب ت ث ن ص ض س ش ـَ ـً ـّـُ ـٌ ـْ ـِ ـٍ ـٰ ـٕ ـٔ  7 ٧ 8 ٨  9 ٩  4 ٤ 5 ٥ 6 ٦ 1 ١  2 ٢  3 ٣ 0٠ ٫ ٬، . ؛ : ؟ ؍ ٪ ـ « » ‹ › ( )    ؎ ے ؏"


ascii = digits+letters+symbols+urdu
xsymbols = u"""€¢£»«›‹÷©®†‡°∙•◦‣¶§÷¡¿▪▫"""
german = u"ÄäÖöÜüß"
...
default = ascii+xsymbols+german+french+portuguese+urdu
